...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('2020-12-01T00:00:00');
...
var changeModalState = function changeModalState(state) {
  ...
  function bindActionToState(event, elem, prop) {
  ...
  bindActionToState('click', windowForm, 'form');
  bindActionToState('input', windowWidth, 'width');
  bindActionToState('input', windowHeight, 'height');
  bindActionToState('change', windowType, 'type');
  bindActionToState('change', windowProfile, 'profile');
};
...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      input = document.querySelectorAll('input'); // modals = document.querySelectorAll('[data-modal]');
    ...
    item.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        setInterval(function () {
          ...
          Object(_closeModal__WEBPACK_IMPORTED_MODULE_6__["default"])('[data-modal]');
        }, 5000);
      });
    });
  });
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        scroll = Object(_calcScroll__WEBPACK_IMPORTED_MODULE_2__["default"])();
  ...
  function showModalByTime(selector, time) {
    setTimeout(function () {
      document.querySelector(selector).style.display = "block", document.body.classList.add('modal-open');
    }, time);
  }
...
var timer = function timer(deadline) {
  ...
  function setTimerValue(timerSelector, daysSelector, daysNameSelector, hoursSelector, hoursNameSelector, minutesSelector, minutesNameSelector, secondsSelector, secondsNameSelector, endTime) {
    var timer = document.getElementById(timerSelector),
    ...
    function updateTimer() {
      ...
      var hours = String(t.hours);
      var minutes = String(t.minutes);
      var seconds = String(t.seconds);
